...
from Alexa.utils.database import get_authuser_names, get_cmode
from Alexa.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from Alexa.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await bot.stop_stream(message.chat.id)
    except:
        pass
