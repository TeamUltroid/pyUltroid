...
import config
from Alexa import Carbon, YouTube, app
from Alexa.core.call import bot
from Alexa.misc import db
from Alexa.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from Alexa.utils.exceptions import AssistantErr
from Alexa.utils.inline.play import (stream_markup,
                                          telegram_markup)
from Alexa.utils.inline.playlist import close_markup
from Alexa.utils.pastebin import botbin
from Alexa.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await bot.force_stop_stream(chat_id)
