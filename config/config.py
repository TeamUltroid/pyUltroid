...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Teambot/AlexaBot",
)
...
)  # Example:- https://t.me/Thebot
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", None
)  # Example:- https://t.me/botSupport
...
# You'll need a Pyrogram String Session for these vars. Generate String from our session generator bot @botStringBot
